...
{
    [TestFixture]
    public class BatchEventProcessorTest : IExceptionHandler
    {
        ...
        {
            Console.WriteLine("ex={0},sequence={1},@event={2}", ex.ToString(), sequence, @event.ToString());
        }

        public void HandleOnStartException(Exception ex)
        {
            Console.WriteLine("HandleOnStartException ,ex={0}", ex.ToString());
        }

        public void HandleOnShutdownException(Exception ex)
        {
            Console.WriteLine("HandleOnShutdownException,ex={0}", ex.ToString());
        }
